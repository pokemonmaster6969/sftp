...
import { User, Lock as LockIcon, ArrowRight, ShieldCheck, Globe, Zap } from 'lucide-react'
...
export const LoginPageOptimized: React.FC<LoginPageProps> = ({ onLogin, initialPath }) => {
        ...
        <Flex pos="relative" h="100%" direction="column" justify="space-between" p={60} c="white" style={{ zIndex: 10 }}>
          ...
          <Box maw={540}>
            <motion.div
              ...
              style={{ willChange: 'transform, opacity' }}
            >
              <Title order={1} style={{ fontSize: 52, fontWeight: 900, lineHeight: 1.05, letterSpacing: -1.5, marginBottom: 24 }}>
                The gateway to
                <Text
                  component="span"
                  style={{
              ...
              <Text size="lg" c="slate.300" style={{ lineHeight: 1.6, opacity: 0.9 }}>
